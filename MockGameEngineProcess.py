...
class MockGameEngineProcess:
    ...
    def receive_from_eval_task(self, eval_to_engine_gamestate, engine_to_viz_gamestate):
        while True:
            try:
    ...
    def mock_game_engine_process_main(self, identified_action, engine_to_eval, eval_to_engine_gamestate, engine_to_viz_gamestate):
        try:
            ...
            receive_from_eval_process = Process(target=self.receive_from_eval_task, args=(eval_to_engine_gamestate, engine_to_viz_gamestate), daemon=False)
